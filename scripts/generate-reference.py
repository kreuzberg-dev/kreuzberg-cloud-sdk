...
GROUPS: list[tuple[str, str, list[str]]] = [
    ...
    (
        ...
        ["list_jobs", "get_job", "get_job_result", "get_job_page", "wait_for_job", "wait_for_jobs", "audit"],
    ),
...
def render(lang: str) -> str:
    ...
    lines = [
        ...
        "",
        f"Package `{package}`. Every method below is on the client; the async client in Python",
